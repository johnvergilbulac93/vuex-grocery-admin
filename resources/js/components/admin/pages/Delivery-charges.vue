        ...
        <div class="text-gray-800 overflow-x-auto">
            <div class=" bg-gray-50 shadow-lg p-2 rounded  overflow-x-auto">
                ...
                >
                    <div
                        v-if="isModal"
                        class=" fixed top-0 left-0 z-50 p-2 flex justify-center items-center w-full min-h-screen"
                    >
                        <div class="sm:w-full lg:w-1/2 bg-white border border-gray-400 rounded shadow-lg ">
                            <div
