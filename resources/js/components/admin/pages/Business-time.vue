        ...
        <div class="bg-gray-50 shadow-lg p-2 rounded text-gray-800 ">
                ...
                >
                    <div class="p-2 tracking-normal">
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="w-full space-y-1">
                                <label for="end" class="font-semibold"
                                    >End</label
                                >
                                <input
                                    tabindex="3"
            ...
            <div class="sm:block md:hidden">
                ...
                >
                    ...
                    <div class="flex justify-center font-bold  w-full">
                        <h2 v-if="!StoreHourList.length">NO AVAILABLE DATA</h2>
                    </div>
                    <div
                        class="w-full my-5 "
                        v-for="(data, i) in StoreHourList"
                    ...
                    >
                        <table
                            class="min-w-full divide-y divide-gray-300 border-2 shadow-md my-5"
                        >
                            ...
                            <tbody>
                                <tr>
                                    <td class="p-2 ">
                                        <button
                                            class="text-white flex gap-1 items-center justify-center hover:text-white p-2 bg-red-500 focus:outline-none focus:bg-red-600  text-center w-full"
                                            @click="remove(data.id)"
                                            data-toggle="tooltip"
                                            data-placement="bottom"
                                            title="Delete"
                                    ...
                                    <td class="p-2">
                                        <router-link
                                            class=" text-white hover:text-white p-2 bg-green-500 focus:outline-none focus:bg-green-600  text-center w-full flex gap-1 items-center justify-center"
                                            :to="'/bu_time/' + data.id"
                                            data-toggle="tooltip"
                                            data-placement="bottom"
                                            title="Edit"
