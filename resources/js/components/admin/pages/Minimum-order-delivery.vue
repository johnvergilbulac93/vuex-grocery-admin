<template>
    <div class="container ">
            ...
            >
                <tbody class="tbody text-center">
                    ...
                    <tr class="tr" v-for="(minorder, i) in MinOrders" :key="i">
                        ...
                        <td class="td">{{ minorder.business_unit }}</td>
                        <td class="td">{{ minorder.name }}</td>
                        <td class="td">{{ minorder.amount }}</td>
                        <td class="td">
                            <button
                            ...
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 text-gray hover:text-green-500"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
        ...
        >
            ...
            >
                <div class="w-96  bg-white rounded sm:m-5 md:m-5">
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            { width: "15%", label: "Store", name: "store" },
            { width: "15%", label: "Department", name: "dept" },
            { width: "15%", label: "Amount", name: "amount" },
